-- ULC Linz App v16 -> v17
-- Ergänzt die vollständigen Übungsinformationen in der Trainingsdokumentation.
-- Keine Tabellen oder bestehende Trainingsdaten werden verändert.
